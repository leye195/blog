...
- easyList (https://adblockplus.org/en/subscriptions,https://easylist.to/easylist/easylist.txt)
- Peter Lowe’s Ad and tracking server list (https://pgl.yoyo.org/adservers/serverlist.php)
- adguardFilters (https://github.com/AdguardTeam/AdguardFilters#adguard-filters)
